...
namespace KitchenAmericanBreakfast.Mains.Waffles
{
    class WafflesDish : CustomDish
    {
        ...
        {
            { Locale.English, "Combine flour, egg, and sugar. Put batter in waffle iron, and close to cook. When cooked, open the iron, plate, and serve." }
        };
